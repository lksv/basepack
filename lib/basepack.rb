...
module Basepack
  ...
  class Railtie < ::Rails::Railtie
    config.app_generators.template_engine :basepack
    config.app_generators.resource_route :basepack_resource_route
    config.app_generators.scaffold_controller :basepack_controller
  end
